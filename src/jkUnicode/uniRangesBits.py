...
unicodeRanges = {
    ...
    38: [
        ("Mathematical Operators", 0x02200, 0x022FF),
    ...
    65: [
        ("Vertical Forms", 0x0FE10, 0x0FE1F),
    ...
    80: [("Khmer", 0x01780, 0x017FF), ("Khmer Symbols", 0x019E0, 0x019FF)],
    81: [("Mongolian", 0x01800, 0x018AF)],
    82: [("Braille Patterns", 0x02800, 0x028FF)],
    83: [
        ("Yi Syllables", 0x0A000, 0x0A48F),
        ("Yi Radicals", 0x0A490, 0x0A4CF),
    ],
    84: [
        ("Tagalog", 0x01700, 0x0171F),
    ...
    91: [
        ("Variation Selectors", 0x0FE00, 0x0FE0F),
